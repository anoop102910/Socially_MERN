    ...
    <div className={`bg-white p-4 rounded-md shadow-md  ${className}`}>
      ...
      <div>
        <form className="max-h-[300px] overflow-y-auto " onSubmit={e => handleSubmit(e)}>
          <textarea value={text} onChange={e => setText(e.target.value)} placeholder="Write some text" className="w-full border rounded-md mt-4 h-28 p-2 outline-none text-gray-700"></textarea>
          {selectedImage && (
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <input accept="image/*" className="py-2 px-4 bg-blue-500 rounded-md text-white hover:bg-blue-600 transition mt-4 " type="submit" value="Post" />
          </div>
        </form>
      </div>
    </div>
